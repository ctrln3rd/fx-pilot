...
export default function About(){
    ...
    return(
        <div className="aboutCont">
            ...
            <h4>Our Mission</h4>
            <p>At fxpilot, our mission is to empower traders with the tools, knowledge, and support they need to succeed in the global Forex market.
                 We are committed to fostering long-term partnerships built on trust, transparency, and mutual success.</p>
            <h4>What Sets Us Apart</h4>
            <ul>
                <li><img src={`${process.env.PUBLIC_URL}/images/fximage7.jpg`} alt="pic"/><span>Personalized Guidance: </span>
                ...
                <li><img src={`${process.env.PUBLIC_URL}/images/fximage6.jpeg`} alt="pic"/><span>Proven Strategies: </span> 
                ...
                <li><img src={`${process.env.PUBLIC_URL}/images/fximage4.jpg`} alt="pic"/><span>Risk Management: </span> Preserving capital is paramount in trading. 
                We prioritize risk management and employ strict measures to mitigate risk and protect your investment.</li>
                <li><img src={`${process.env.PUBLIC_URL}/images/fximage5.jpg`} alt="pic"/><span>Transparent Communication: </span> Transparency is at the core of our values. We believe in open and honest communication, 
            ...
            <p>At fxpilot, excellence is not just a goal—it's a standard we strive to uphold in everything we do. We are dedicated to delivering superior value, 
